        ...
        try:
            ...
            try:
                ...
                with open(self.model_path, 'rb') as f:
                    # Disable unpickling of sklearn objects that require scipy
                    # by handling import errors gracefully
            ...
            logger.error(f"Model will NOT be available - using demo mode only")
            self.model = None
